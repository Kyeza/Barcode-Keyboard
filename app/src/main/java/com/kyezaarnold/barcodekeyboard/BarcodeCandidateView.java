 ...
 */
public class BarcodeCandidateView extends View {

    private static final int OUT_OF_BOUNDS = -1;

    private BarcodeKeyboard mService;
    ...
    public BarcodeCandidateView(Context context) {
        super(context);
     ...
     * @param listener
     */
    public void setService(BarcodeKeyboard listener) {
        mService = listener;
    }
